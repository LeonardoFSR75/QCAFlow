...
Generative AI (Google Gemini via the Antigravity pair-programming agent) was used during the development of this project. AI assistance was utilized for:
- Writing test scaffolding and core logic refactoring in the JavaScript codebase.
- Assisting with the drafting and copy-editing of the paper text (`paper.md`) and technical documentation.
